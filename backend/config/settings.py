...
TURNSTILE_ENABLED = env_bool('TURNSTILE_ENABLED', default=not DEBUG)
TURNSTILE_SECRET_KEY = os.getenv('TURNSTILE_SECRET_KEY', '')
TURNSTILE_VERIFY_TIMEOUT_SECONDS = int(os.getenv('TURNSTILE_VERIFY_TIMEOUT_SECONDS', '8'))

WEB_AUTH_SESSION_TTL_SECONDS = int(os.getenv('WEB_AUTH_SESSION_TTL_SECONDS', '900'))
WEB_LOGIN_RATE_LIMIT_PER_MINUTE = int(os.getenv('WEB_LOGIN_RATE_LIMIT_PER_MINUTE', '5'))
WEB_LOGIN_RATE_LIMIT_PER_EMAIL_WINDOW = int(os.getenv('WEB_LOGIN_RATE_LIMIT_PER_EMAIL_WINDOW', '5'))
WEB_LOGIN_EMAIL_WINDOW_SECONDS = int(os.getenv('WEB_LOGIN_EMAIL_WINDOW_SECONDS', '600'))
WEB_REGISTER_RATE_LIMIT_PER_HOUR = int(os.getenv('WEB_REGISTER_RATE_LIMIT_PER_HOUR', '3'))
WEB_REGISTER_RATE_LIMIT_PER_EMAIL_DAY = int(os.getenv('WEB_REGISTER_RATE_LIMIT_PER_EMAIL_DAY', '3'))
SOCIAL_START_RATE_LIMIT_PER_WINDOW = int(os.getenv('SOCIAL_START_RATE_LIMIT_PER_WINDOW', '10'))
SOCIAL_START_RATE_LIMIT_WINDOW_SECONDS = int(os.getenv('SOCIAL_START_RATE_LIMIT_WINDOW_SECONDS', '600'))

SOCIAL_OAUTH_STATE_TTL_SECONDS = int(os.getenv('SOCIAL_OAUTH_STATE_TTL_SECONDS', '600'))
SOCIAL_OAUTH_TIMEOUT_SECONDS = int(os.getenv('SOCIAL_OAUTH_TIMEOUT_SECONDS', '8'))
GOOGLE_OAUTH_CLIENT_ID = os.getenv('GOOGLE_OAUTH_CLIENT_ID', '')
GOOGLE_OAUTH_CLIENT_SECRET = os.getenv('GOOGLE_OAUTH_CLIENT_SECRET', '')
GOOGLE_OAUTH_REDIRECT_URI = os.getenv(
    'GOOGLE_OAUTH_REDIRECT_URI',
    f'{PUBLIC_API_ORIGIN}/api/auth/social/google/callback' if PUBLIC_API_ORIGIN else '',
)
GITHUB_OAUTH_CLIENT_ID = os.getenv('GITHUB_OAUTH_CLIENT_ID', '')
GITHUB_OAUTH_CLIENT_SECRET = os.getenv('GITHUB_OAUTH_CLIENT_SECRET', '')
GITHUB_OAUTH_REDIRECT_URI = os.getenv(
    'GITHUB_OAUTH_REDIRECT_URI',
    f'{PUBLIC_API_ORIGIN}/api/auth/social/github/callback' if PUBLIC_API_ORIGIN else '',
)

TELEGRAM_BOT_TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '')
TELEGRAM_BOT_USERNAME = os.getenv('TELEGRAM_BOT_USERNAME', '')
TELEGRAM_WEBHOOK_SECRET = os.getenv('TELEGRAM_WEBHOOK_SECRET', '')
TELEGRAM_REQUEST_TIMEOUT_SECONDS = int(os.getenv('TELEGRAM_REQUEST_TIMEOUT_SECONDS', '8'))
TELEGRAM_LINK_TOKEN_TTL_SECONDS = int(os.getenv('TELEGRAM_LINK_TOKEN_TTL_SECONDS', '900'))
TELEGRAM_OTP_TTL_SECONDS = int(os.getenv('TELEGRAM_OTP_TTL_SECONDS', '300'))
TELEGRAM_OTP_MAX_ATTEMPTS = int(os.getenv('TELEGRAM_OTP_MAX_ATTEMPTS', '5'))
TELEGRAM_OTP_RESEND_COOLDOWN_SECONDS = int(os.getenv('TELEGRAM_OTP_RESEND_COOLDOWN_SECONDS', '60'))
TELEGRAM_OTP_RESEND_RATE_LIMIT_PER_WINDOW = int(os.getenv('TELEGRAM_OTP_RESEND_RATE_LIMIT_PER_WINDOW', '3'))
TELEGRAM_OTP_RESEND_WINDOW_SECONDS = int(os.getenv('TELEGRAM_OTP_RESEND_WINDOW_SECONDS', '900'))
...
PERSONALIZED_FEED_PENDING_STALE_SECONDS = int(os.getenv('PERSONALIZED_FEED_PENDING_STALE_SECONDS', '45'))
PERSONALIZED_FEED_RUNNING_STALE_SECONDS = int(os.getenv('PERSONALIZED_FEED_RUNNING_STALE_SECONDS', '600'))
